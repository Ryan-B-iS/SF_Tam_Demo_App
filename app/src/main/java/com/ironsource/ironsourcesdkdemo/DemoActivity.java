...
public class DemoActivity extends Activity implements RewardedVideoListener, OfferwallListener, InterstitialListener, ImpressionDataListener, SegmentListener {

    private final String TAG = "DemoActivity";
    private final String APP_KEY = "xxxxxxxxx";
    ...
    private Button deSegButton;
    private IronSourceSegment segPay;
    private IronSourceSegment segNoPay;
    ...
    private void initIronSource(String appKey, String userId) {
        ...
        //set the segment
        segPay = new IronSourceSegment();

        segNoPay = new IronSourceSegment();
//        segPay.setSegmentName("segmentNOTPaying");

        segPay.setIsPaying(true);
        segNoPay.setIsPaying(false);

        IronSource.setSegment(segNoPay);
        Log.d(TAG, "Initializing segment to " + segPay.getSegmentName());
    ...
    private void initUIElements() {
        ...
        segButton = (Button) findViewById(R.id.payButton);
        segButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                IronSource.setSegment(segPay);
                Log.d("INFO","setPaying true");


            }
        });

        deSegButton = (Button) findViewById(R.id.noPayButton);
        deSegButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                IronSource.setSegment(segNoPay);
                Log.d("INFO", "setPaying false");
...
//         IronSourceError.getErrorMessage();
    ...
    public void onSegmentReceived(String segment){
        Log.d("UNIQUETAG", "Segment Received: " + segment);
    }
